...
class  NormalDialog extends StatelessWidget {
  ...
  const NormalDialog({super.key, this.onPress1stButton, required this.title, required this.description, required this.text1stButton, required this.dialogDismiss});
            ...
            children: <Widget>[
              Container(
                ...
                child: Column(
                  ...
                  children: [
Text(title?? "Thông báo",style: TextStyle(
                                      fontSize: 16,
...
onPress1stButton ?? closePopup(context);
